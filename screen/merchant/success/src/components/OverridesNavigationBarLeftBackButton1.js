...
function OverridesNavigationBarLeftBackButton1(props) {
  return (
    <View style={[styles.root, props.style]}>
      <View style={styles.pinLeft}>
        <View style={styles.path3Stack}>
          <Svg viewBox="-0 -0 12 21" style={styles.path3}>
            <Path
              strokeWidth={0}
          ...
          <Svg viewBox="-0 -0 24 24" style={styles.shape201}>
            <Path
              strokeWidth={0}
              fill="transparent"
              fillOpacity={1}
...
export default OverridesNavigationBarLeftBackButton1;
